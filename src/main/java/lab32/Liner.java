...
abstract class AbstractShip implements Comparable<AbstractShip> {
    ...
    public int compareTo(AbstractShip abstractShip){
        float comparePayment = ((AbstractShip) abstractShip).calculatePayment();

        return (int) (this.calculatePayment() - comparePayment);
    }
